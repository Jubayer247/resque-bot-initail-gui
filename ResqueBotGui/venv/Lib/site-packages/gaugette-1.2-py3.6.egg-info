...
Name: gaugette
Version: 1.2
Summary: Python library for building embedded devices with the Raspberry Pi
Home-page: http://github.com/guyc/py-gaugette/
Author: Guy Carpenter
Author-email: guy@clearwater.com.au
License: LICENSE.txt
Description: ===============
